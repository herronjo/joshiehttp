...
Update: PHP support now added. Some (_most_) features don't work, since it's just called directly from the command line, but it's a start! Just make sure PHP is installed on your server. Happy scripting!
